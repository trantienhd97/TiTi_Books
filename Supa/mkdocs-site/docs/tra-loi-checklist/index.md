...
Spec triển khai: [`docs/tra-loi-checklist-offline/README.md`](../tra-loi-checklist-offline/) — cache snapshot inspection, hàng đợi sync, upload media local, hoàn thành offline, auto-sync nền toàn app.

## Liên kết

- [`docs/tra-loi-checklist-offline/README.md`](../tra-loi-checklist-offline/) — spec chế độ offline (đang lên kế hoạch)
- [`docs/chi-tiet-checklist/README.md`](../chi-tiet-checklist/) — màn cha, điều hướng Tiếp tục / Evaluate
- [`docs/checklist/README.md`](../checklist/) — danh sách checklist
