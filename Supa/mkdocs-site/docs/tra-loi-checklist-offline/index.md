...
- Sau implement: cập nhật section "Chế độ offline" trong [`docs/tra-loi-checklist/README.md`](../tra-loi-checklist/).
...
- [`docs/tra-loi-checklist/README.md`](../tra-loi-checklist/) — màn trả lời checklist (baseline)
- [`docs/chi-tiet-checklist/README.md`](../chi-tiet-checklist/) — màn cha, điều hướng Tiếp tục
